...
library(tidyr);library(ggplot2);library(designmatch);library(MatchIt);library(Matching);library(sensitivitymv);library(sensitivitymw);library(knitr);library(cobalt)
```
...
mom_covs = lalonde[,c("age", "educ", "black" ,"hispan", "married", "nodegree", "re74", "re75")]
